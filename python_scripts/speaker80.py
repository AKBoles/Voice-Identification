...
training_data = '/home/cc/Data/Full-80-Person/'
training_seg = '/home/cc/Data/Segment-80-Two/'
...
#    X.append(mfcc)
#pickle.dump(X, open('/home/cc/Data/pickle_files/speaker80_2secX.p', 'wb'))
#pickle.dump(Y, open('/home/cc/Data/pickle_files/speaker80_2secY.p', 'wb'))

X = pickle.load(open('/home/cc/Data/pickle_files/speaker80_2secX.p', 'rb'))
Y = pickle.load(open('/home/cc/Data/pickle_files/speaker80_2secY.p', 'rb'))
speakers = speech_data.get_speakers(training_seg)
...
# for just mfcc
net = tflearn.input_data(shape=[None, 20, 44])
...
model.fit(X, Y, n_epoch=500, show_metric=True, snapshot_step=1000, run_id='OCISpeakerRec')
